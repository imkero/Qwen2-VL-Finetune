...
class FocalOrCETrainer(QwenSFTTrainer):
    ...
    def _compute_loss_func(
        ...
        **kwargs,
        ...
        loss = focal_or_ce_causal_lm_loss(
            ...
            shift_labels=outputs.get("shift_labels", None),
            label_smoothing_ce=self._label_smoothing_ce,
            label_smoothing_fl=self._label_smoothing_fl,
        )
        return loss
